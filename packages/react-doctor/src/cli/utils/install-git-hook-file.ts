...
const PNPM_REACT_DOCTOR_COMMAND = `pnpm dlx ${FORK_PACKAGE_SPEC} --staged --blocking warning`;
const NPX_REACT_DOCTOR_COMMAND = `npx --yes ${FORK_PACKAGE_SPEC} --staged --blocking warning`;
