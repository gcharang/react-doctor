...
// GitHub Actions?" prompt's "Read docs" choice opens this directly. On the
// fork this lands on the repo (README covers CI/CD setup) instead of
// react.doctor.
export const GITHUB_ACTIONS_SETUP_URL = FORK_REPO_URL;
...
// Shared timeout for outbound HTTP calls (the fork keeps it only for the
// Socket.dev supply-chain check; the score HTTP layer was removed).
