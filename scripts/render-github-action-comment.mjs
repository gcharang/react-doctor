...
const BRAND_IMAGE_URL =
  "https://raw.githubusercontent.com/gcharang/react-doctor/pinned/packages/website/public/react-doctor-og-banner.svg";
const BRAND_LINK_URL = "https://github.com/gcharang/react-doctor";
...
const BRAND_FOOTER = `Generated by [React Doctor](${BRAND_LINK_URL}). Questions? Open an issue at ${BUG_REPORT_URL}/issues.`;
